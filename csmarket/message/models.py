...
class Message(models.Model):
    ...
    mess_totalnum = models.IntegerField(verbose_name='有效数',default=1)
    mess_compeletenum = models.IntegerField(verbose_name='已成交次数',default=0)
...
class DMessage(models.Model):
    ...
    dmess_totalnum = models.IntegerField(verbose_name='有效数',default=1)
    dmess_compeletenum = models.IntegerField(verbose_name='已成交次数',default=0)
